...
# This creates a screen, gives the screen a title, sets a background colour,
# Creates a custom screen height and width and stops window form updating
wn = turtle.Screen()
wn.title("Pong by Badr_Elkholy")
wn.bgcolor("black")
